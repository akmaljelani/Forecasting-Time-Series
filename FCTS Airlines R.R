...
## creating 12 dummy variable for 12 months
X<- data.frame(outer(rep(month.abb,length = 96), month.abb,"==") + 0 )
View(X)
colnames(X)<-month.abb # Assigning month names instead of X
View(X)
...
rmse_Add_season 
# RMSE is 132.8 and Adjusted R2 is 0.04
# Adjusted R2 is too low, Hence, it may not be additive seasonality model.
...
rmse_Add_sea_Linear 
# RMSE is 35.348 and Adjusted R2 is 0.947
...
# Adjusted R2 is too low, Hence, it may not be Multiplicative Seasonality model.
